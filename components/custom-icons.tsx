export function ShieldIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 2L3 7v6c0 5 4 10 9 10s9-5 9-10V7l-9-5z" />
...
export function EyeIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M12 5c-7.2 0-9 7-9 7s1.8 7 9 7 9-7 9-7-1.8-7-9-7z" />
...
export function CodeIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <line x1="12" y1="2" x2="12" y2="22" transform="rotate(-30 12 12)" />
    </svg>
  )
}
